...
if (!($cmd)) {
    "Usage: scoopydoo <command> [<args>]

Some useful commands are:"
    print_summaries
    "Type 'scoopydoo help <command>' to get help for a specific command."
} elseif($commands -contains $cmd) {
    print_help $cmd
} else {
    "scoopydoo help: no such command '$cmd'"; exit 1
}
